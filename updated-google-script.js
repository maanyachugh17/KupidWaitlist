...
function doPost(e) {
  try {
    ...
    // Extract phone numbers from existing data (assuming phone is in column 3)
...
// 🧹 Bonus: Function to clean existing duplicates
function cleanExistingDuplicates() {
  try {
    ...
    for (var i = 0; i < rows.length; i++) {
      ...
      if (normalizedPhone && seen.indexOf(normalizedPhone) === -1) {
