...
const VerificationForm = ({ onVerificationComplete }) => {
  ...
  const sendVerificationCode = async () => {
    ...
    try {
      const response = await fetch('https://cors-anywhere.herokuapp.com/https://script.google.com/macros/s/AKfycbyRO-4crziX7xy61s8Ztt_e6ZCh5YfZb79bPLYjIHpnWdDnBThHToHawkI1b8FPUwTE/exec', {
        method: 'POST',
        headers: {
