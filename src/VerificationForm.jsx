...
const VerificationForm = ({ onVerificationComplete }) => {
  ...
  const sendVerificationCode = async () => {
    ...
    try {
      const response = await fetch('https://cors-anywhere.herokuapp.com/https://script.google.com/macros/s/AKfycbzsqLzg1KM1rabsesMQOifWi-ZFSEEb6wvkZ6Uq25W4yOj1v6mviFMx0TkSZw_lTrzl/exec', {
        method: 'POST',
        headers: {
